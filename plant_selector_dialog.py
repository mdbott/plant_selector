...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'plant_selector_dialog_base.ui'))


class PlantSelectorDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(PlantSelectorDialog, self).__init__(parent)
